...
void FDynamicTerrainModeToolkit::Init(const TSharedPtr< class IToolkitHost >& InitToolkitHost)
{
	...
	ModeButtons.AddToolBarButton(FDynamicTerrainEditorCommands::Get().FoliageMode, NAME_None,
		LOCTEXT("FoliageModeName", "Foliage"),
		LOCTEXT("FoliageModeDesc", "Change the foliage generated by a terrain"),
		FSlateIcon(FDynamicTerrainStyle::GetName(), "Plugins.Mode.Foliage"));
