...
public:
	...
	PointNoise(uint32 XWidth, uint32 YWidth, uint32 NumPoints, uint32 Seed, bool PreSort = false);
	// Generate noise in a cirlce
	PointNoise(uint32 Radius, uint32 NumPoints, uint32 Seed, bool PreSort = false);
...
private:
	...
	TArray<TArray<FVector2D*>> PointGrid;
};
